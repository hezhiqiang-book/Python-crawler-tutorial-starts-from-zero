...
* [百度翻译爬虫](03-bai-du-fan-yi.md#百度翻译爬虫)
  * [分析](03-bai-du-fan-yi.md#分析)
    * [分析流程](03-bai-du-fan-yi.md#分析流程)
    * [分析结果](03-bai-du-fan-yi.md#分析结果)
      * [请求参数分析](03-bai-du-fan-yi.md#请求参数分析)
    * [JS 逆向流程](03-bai-du-fan-yi.md#js-逆向流程)
      * [chrome 调试技巧](03-bai-du-fan-yi.md#chrome-调试技巧)
        * [JS 逆向流程](03-bai-du-fan-yi.md#js-逆向流程-1)
      * [根据逆向流程查找我们所需的js代码](03-bai-du-fan-yi.md#根据逆向流程查找我们所需的js代码)
    * [编写爬虫代码](03-bai-du-fan-yi.md#编写爬虫代码)
      * [注意](03-bai-du-fan-yi.md#注意)
      * [最后](03-bai-du-fan-yi.md#最后)
    * [完整代码](03-bai-du-fan-yi.md#完整代码)
...
> url : [https://fanyi.baidu.com/\#en/zh/](https://fanyi.baidu.com/#en/zh/)

#### 分析流程

1. 将浏览器切换至手机端，这样查看请求的参数可能会较少，点击下图中的按钮：

![](.gitbook/assets/qie-huan-shou-ji-duan.jpg)

1. 查看请求接口

![](.gitbook/assets/bai-du-fan-yi-qing-qiu.jpg)

1. 查看请求参数是否有变化
2. 图一： ![](.gitbook/assets/fa-song-qing-qiu-de-shu-ju.jpg)
3. 图二： ![](.gitbook/assets/can-shu-bian-hua.jpg)
...
| --分析目标--- | ----分析结果------------------- |
| :--- | :--- |
| 请求URL分析 | [https://fanyi.baidu.com/basetrans](https://fanyi.baidu.com/basetrans) |
| 请求方式分析 | POST |
| 请求参数分析 | 参看请求参数分析 |
| 请求头分析 | 参看请求头分析 |
...
![](.gitbook/assets/cha-zhao-bai-du-fan-yi-jie-kou.jpg)

1. 跟进代码，分析AJAX请求

![](.gitbook/assets/gen-jin-bai-du-js.jpg)

1. 查找我们需要的值

![](.gitbook/assets/find_g.jpg)

* 准确的找到我们需要的值

![](.gitbook/assets/sheng-cheng-han-shu.png)

* 复制我们需要的js代码

![](.gitbook/assets/fu-zhi-js-dai-ma.jpg)
...
* 逆向分析
* 我们回到 `function a()`中，找到需要使用 `i`值的地方，打上断点

![](.gitbook/assets/huo-quida-duan-dian.jpg)

1. 打上断点之后刷新一下页面,我们再次将鼠标放在 `i`上，我们会看到一个浮点字符串，此时我们不确定 `i` 的值是否是变化的，所以我们换一个翻译的单词，刷新页面，再次查看 `i` 的值，我们发现 `i` 的值是固定的，所以我们可以在代码中，直接定义一个固定的`i` 值.

![](.gitbook/assets/zhao-daoide-zhi.png)
